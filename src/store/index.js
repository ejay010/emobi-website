  ...
  actions: {
    ...
    LoginUser (context, userData) {
      ...
      return new Promise((resolve, reject) => {
        ...
        }).post('http://localhost:3000/customerLogin', userData)
        .then(response => {
    ...
    createEvent (context, baseData) {
      ...
      return new Promise(
        (resolve, reject) => {
          axios.create({
            withCredentials: true
          }).post('http://localhost:3000/createEvent', creationData).then(response => {
            resolve(response)
          }).catch(e => {
            reject(e)
          })
...
/* eslint-enable no-console */
    publishEvent (context, eventID){
      let url = 'http://localhost:3000/event/'+eventID+'/publish'
      return new Promise(
        (resolve, reject) => {
          axios.create({
            withCredentials: true
    ...
    cancelEvent (context, eventID){
      let url = 'http://localhost:3000/event/'+eventID+'/cancel'
      return new Promise((resolve, reject) => {
        axios.create({
          withCredentials: true
        }).get(url).then(response => {
